...
module SRAM (A,DO,DI,CK,WEB,OE, CS);
...
`protect
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA  = (277:395:633);
      specparam TWDV = (208:296:475);
      specparam TRC  = (277:395:633);
      specparam THPW = (33:55:91);
      specparam TLPW = (33:55:91);
      specparam TAS  = (63:83:125);
      specparam TAH  = (10:10:10);
      specparam TWS  = (50:63:91);
      specparam TWH  = (10:10:10);
      specparam TDS  = (56:75:114);
      specparam TDH  = (10:10:10);
      specparam TCSS = (78:103:156);
      specparam TCSH = (0:10:29);
      specparam TOE      = (72:110:178);
      specparam TOZ      = (63:81:116);
      ...
      $setuphold ( posedge CK &&& con_A,          posedge A[13], TAS,     TAH,     n_flag_A13     );
      $setuphold ( posedge CK &&& con_A,          negedge A[13], TAS,     TAH,     n_flag_A13     );
      ...
      $setuphold ( posedge CK &&& con_DI,         posedge DI[22], TDS,     TDH,     n_flag_DI22    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[22], TDS,     TDH,     n_flag_DI22    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[23], TDS,     TDH,     n_flag_DI23    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[23], TDS,     TDH,     n_flag_DI23    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[24], TDS,     TDH,     n_flag_DI24    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[24], TDS,     TDH,     n_flag_DI24    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[25], TDS,     TDH,     n_flag_DI25    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[25], TDS,     TDH,     n_flag_DI25    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[26], TDS,     TDH,     n_flag_DI26    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[26], TDS,     TDH,     n_flag_DI26    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[27], TDS,     TDH,     n_flag_DI27    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[27], TDS,     TDH,     n_flag_DI27    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[28], TDS,     TDH,     n_flag_DI28    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[28], TDS,     TDH,     n_flag_DI28    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[29], TDS,     TDH,     n_flag_DI29    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[29], TDS,     TDH,     n_flag_DI29    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[30], TDS,     TDH,     n_flag_DI30    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[30], TDS,     TDH,     n_flag_DI30    );
      $setuphold ( posedge CK &&& con_DI,         posedge DI[31], TDS,     TDH,     n_flag_DI31    );
      $setuphold ( posedge CK &&& con_DI,         negedge DI[31], TDS,     TDH,     n_flag_DI31    );
